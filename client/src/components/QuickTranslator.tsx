...
export function QuickTranslator() {
  ...
  return (
    <div className="relative w-full rounded-3xl bg-gradient-to-b from-[#02130e]/95 via-[#021812]/95 to-[#010b08]/95 border border-[#F8E7C9]/20 p-6 sm:p-7 shadow-[0_10px_60px_rgba(0,0,0,0.8)] text-[#F8E7C9] overflow-hidden select-none animate-in fade-in zoom-in-95 duration-200">
      ...
      {/* Sarlavha qismi */}
      <div className="relative z-10 mb-5 flex items-center justify-between pb-3 border-b border-[#F8E7C9]/10">
